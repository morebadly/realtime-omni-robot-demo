...
console.log('Provider real handshake probe plan smoke passed: 2 candidates, disabled-by-default, 31-check suite, no real network, no raw key leak, fallback=localdev_mock');
